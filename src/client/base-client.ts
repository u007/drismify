...
import { applyExtension, Extension, defineExtension, getExtensionContext } from '../extensions';
...
export class DrismifyClient implements BaseClient {
  ...
  protected ensureConnected(): void {
    if (!this.isConnected) {
      throw new Error('Client is not connected to the database. Call connect() first.');
    }
  }
}
