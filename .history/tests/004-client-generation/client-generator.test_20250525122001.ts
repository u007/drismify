...
describe('Client Generator', () => {
  ...
  describe('Basic Client Generation', () => {
    it('should generate a client from a basic schema', async () => {
      ...
      expect(userContent).toContain('super(client, modelAst, \'user\', debug, log, dbInstance);');
      ...
      expect(postContent).toContain('super(client, modelAst, \'post\', debug, log, dbInstance);');
    });
  });
